...
const createTime = (e, t = "") => {
 ...
 if (appData.BUILD.updatable) for (o of sortedAttrNames(Object.keys(n))) o in l || setAccessor(s, o, n[o], void 0, a, t.$flags$);
 for (o of sortedAttrNames(Object.keys(l))) setAccessor(s, o, n[o], l[o], a, t.$flags$);
};
...
const createElm = (e, t, a, o) => {
 ...
 relocateToHostRoot(t.$elm$.parentElement)) : updateElement(e, t, isSvgMode)), appData.BUILD.updatable && null !== s && null !== n ? ((e, t, a, o, s = !1) => {
  let n, l, r = 0, i = 0, p = 0, d = 0, c = t.length - 1, $ = t[0], u = t[c], h = o.length - 1, m = o[0], f = o[h];
  for (;r <= c && i <= h; ) if (null == $) $ = t[++r]; else if (null == u) u = t[--c]; else if (null == m) m = o[++i]; else if (null == f) f = o[--h]; else if (isSameVnode($, m, s)) patch($, m, s), 
  $ = t[++r], m = o[++i]; else if (isSameVnode(u, f, s)) patch(u, f, s), u = t[--c], 
  f = o[--h]; else if (isSameVnode($, f, s)) !appData.BUILD.slotRelocation || "slot" !== $.$tag$ && "slot" !== f.$tag$ || putBackInOriginalLocation($.$elm$.parentNode, !1), 
  patch($, f, s), e.insertBefore($.$elm$, u.$elm$.nextSibling), $ = t[++r], f = o[--h]; else if (isSameVnode(u, m, s)) !appData.BUILD.slotRelocation || "slot" !== $.$tag$ && "slot" !== f.$tag$ || putBackInOriginalLocation(u.$elm$.parentNode, !1), 
...
const callRender = (e, t, a, o) => {
 ...
 e.__appendChild = e.appendChild, e.appendChild = function(e) {
  const t = e["s-sn"] = getSlotName(e), a = getHostSlotNode(this.childNodes, t, this.tagName);
  if (a) {
 ...
 e.prepend = function(...e) {
  e.forEach((e => {
   ...
   const a = e["s-sn"] = getSlotName(e), o = getHostSlotNode(this.childNodes, a, this.tagName);
   if (o) {
 ...
 return t;
}, getSlotName = e => e["s-sn"] || 1 === e.nodeType && e.getAttribute("slot") || "", getHostSlotNode = (e, t, a) => {
 let o, s = 0;
 for (;s < e.length; s++) {
  if (o = e[s], o["s-sr"] && o["s-sn"] === t && o["s-hn"] === a) return o;
