...
const createTime = (e, t = "") => {
 ...
 if (BUILD.updatable) for (n of sortedAttrNames(Object.keys(l))) n in a || setAccessor(s, n, l[n], void 0, o, t.$flags$);
...
const callRender = (e, t, o, n) => {
 ...
 e.__appendChild = e.appendChild, e.appendChild = function(e) {
  const t = e["s-sn"] = getSlotName(e), o = getHostSlotNode(this.childNodes, t, this.tagName);
  if (o) {
 ...
 e.prepend = function(...e) {
  e.forEach((e => {
   ...
   const o = e["s-sn"] = getSlotName(e), n = getHostSlotNode(this.childNodes, o, this.tagName);
   if (n) {
 ...
 return t;
}, getSlotName = e => e["s-sn"] || 1 === e.nodeType && e.getAttribute("slot") || "", getHostSlotNode = (e, t, o) => {
 let n, s = 0;
 for (;s < e.length; s++) {
  if (n = e[s], n["s-sr"] && n["s-sn"] === t && n["s-hn"] === o) return n;
