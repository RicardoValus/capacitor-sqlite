...
function getMismatchedPixels(pixelMatchInput) {
    const imgA = fs__default['default'].createReadStream(pixelMatchInput.imageAPath).pipe(new PNG_1()).on('parsed', doneReading);
    const imgB = fs__default['default'].createReadStream(pixelMatchInput.imageBPath).pipe(new PNG_1()).on('parsed', doneReading);
    let filesRead = 0;
