...
const Searchbar = class {
    ...
    render() {
        ...
        const cancelButton = this.showCancelButton !== 'never' && (index.h("button", { key: 'e3bb8a3d55a7fabef63739950c43a2ee503426ee', "aria-label": cancelButtonText, "aria-hidden": shouldShowCancelButton ? undefined : 'true', type: "button", tabIndex: mode === 'ios' && !shouldShowCancelButton ? -1 : undefined, onMouseDown: this.onCancelSearchbar, onTouchStart: this.onCancelSearchbar, class: "searchbar-cancel-button" }, index.h("div", { key: 'c4355f1140a001871791849505399bb06d30345a', "aria-hidden": "true" }, mode === 'md' ? (index.h("ion-icon", { "aria-hidden": "true", mode: mode, icon: this.cancelButtonIcon, lazy: false })) : (cancelButtonText))));
        return (index.h(index.Host, { key: '3acc4483c92eebc97b0d3ea355386fb9218d818e', role: "search", "aria-disabled": this.disabled ? 'true' : null, class: theme.createColorClasses(this.color, {
                [mode]: true,
            ...
            }) }, index.h("div", { key: '9fc7e797b6e37ea59236322faea7afc30107cb56', class: "searchbar-input-container" }, index.h("input", Object.assign({ key: '64ec1ca4ad868e1034ebdd575926d78d98bbd24d', "aria-label": "search text", disabled: this.disabled, ref: (el) => (this.nativeInput = el), class: "searchbar-input", inputMode: this.inputmode, enterKeyHint: this.enterkeyhint, name: this.name, onInput: this.onInput, onChange: this.onChange, onBlur: this.onBlur, onFocus: this.onFocus, minLength: this.minlength, maxLength: this.maxlength, placeholder: this.placeholder, type: this.type, value: this.getValue(), autoCapitalize: autocapitalize === 'default' ? undefined : autocapitalize, autoComplete: this.autocomplete, autoCorrect: this.autocorrect, spellcheck: this.spellcheck }, this.inheritedAttributes)), mode === 'md' && cancelButton, index.h("ion-icon", { key: '80cb1d76a8a57eb12b60157e4d0ebc30e8abfd8d', "aria-hidden": "true", mode: mode, icon: searchIcon, lazy: false, class: "searchbar-search-icon" }), index.h("button", { key: '39717f84cb4ac1cbf8296b641b4d0a980eed9f74', "aria-label": "reset", type: "button", "no-blur": true, class: "searchbar-clear-button", onPointerDown: (ev) => {
                /**
                 ...
                 */
                ev.preventDefault();
            }, onClick: () => this.onClearInput(true) }, index.h("ion-icon", { key: '766a0d51a4ef95dcd5332e935b3f6181ddc06863', "aria-hidden": "true", mode: mode, icon: clearIcon, lazy: false, class: "searchbar-clear-icon" }))), mode === 'ios' && cancelButton));
    }
