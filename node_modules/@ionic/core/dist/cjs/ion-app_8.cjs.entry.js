...
const hardwareBackButton = require('./hardware-back-button-d76ddd64.js');
...
const index$3 = require('./index-9d02ee85.js');
    ...
    componentDidLoad() {
        {
            rIC(async () => {
                ...
                if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-1d7f8e6d.js'); }).then((module) => module.startStatusTap());
                }
                ...
                const hardwareBackButtonModule = await Promise.resolve().then(function () { return require('./hardware-back-button-d76ddd64.js'); });
