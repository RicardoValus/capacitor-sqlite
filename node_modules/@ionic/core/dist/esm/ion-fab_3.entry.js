 ...
 */
import { r as registerInstance, h, H as Host, f as getElement, d as createEvent } from './index-73fa3fe8.js';
import { b as getIonMode } from './ionic-global-d89a6ff6.js';
...
const Fab = class {
    ...
    render() {
        ...
        return (h(Host, { key: '2960656845d8ab1d643e56870cfeefbceb44fb20', class: {
                [mode]: true,
                [`fab-horizontal-${horizontal}`]: horizontal !== undefined,
                [`fab-vertical-${vertical}`]: vertical !== undefined,
                'fab-edge': edge,
            } }, h("slot", { key: 'eed164a50594167959905a90d678d417bc99098d' })));
    }
...
const FabButton = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'c6d1a3ea95ee1fb6c86447881ff8ed7d885b9fb5', onClick: this.onClick, "aria-disabled": disabled ? 'true' : null, class: createColorClasses(color, {
                [mode]: true,
            ...
            }) }, h(TagType, Object.assign({ key: 'd57e55e43e3e1fa7a255e25bfb9eb81a20200aa4' }, attrs, { class: "button-native", part: "native", disabled: disabled, onFocus: this.onFocus, onBlur: this.onBlur, onClick: (ev) => openURL(href, ev, this.routerDirection, this.routerAnimation) }, inheritedAttributes), h("ion-icon", { key: '561252585dc5f5ed260987fc8fef2558700b2700', "aria-hidden": "true", icon: this.closeIcon, part: "close-icon", class: "close-icon", lazy: false }), h("span", { key: 'd156660a55d4d849c24368ee79217e66c6423b37', class: "button-inner" }, h("slot", { key: '35d4507eec7e4f646e1ef9206b8d6c9fd5a43c37' })), mode === 'md' && h("ion-ripple-effect", null))));
    }
    get el() { return getElement(this); }
};
FabButton.style = {
...
const FabList = class {
    ...
    render() {
        const mode = getIonMode(this);
        return (h(Host, { key: 'edbed7730aa2f177a6fb39a89af805b9699bc9ae', class: {
                [mode]: true,
                'fab-list-active': this.activated,
                [`fab-list-side-${this.side}`]: true,
            } }, h("slot", { key: '3ecb467b6d09dc02a1ab3cb76403f7c56e8ec6b2' })));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "activated": ["activatedChanged"]
